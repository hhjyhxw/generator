...
//        }
        ...
        if (template.contains("service.java.vm")) {
            return packagePath + "service" + File.separator +sonModule+File.separator+className + "Service.java";
        }
        if (template.contains("mapper.java.vm")) {
            return packagePath + "dao"+ File.separator + sonModule+File.separator+ className + "Mapper.java";
        }
        if (template.contains("entity.java.vm")) {
            return packagePath + "model" + File.separator + sonModule+File.separator+ className + ".java";
        }
